    ...
    grunt.initConfig({
        ...
        replace: {
          ...
          assemblyInfo: {
              ...
              files: [
                  { src: "src/Angara.Html/AssemblyInfo.fs", dest: "src/Angara.Html/AssemblyInfo.fs" },
                  { src: "src/Angara.Base/AssemblyInfo.fs", dest: "src/Angara.Base/AssemblyInfo.fs" },
                  { src: "src/Angara.Reinstate/AssemblyInfo.fs", dest: "src/Angara.Reinstate/AssemblyInfo.fs" }
              ]
          }    
        }
    });
